...
import { getNavbarReceivedCrypto, getNavbarTransaction } from '../../UI/Navbar';
 ...
 */
class ReceivedCrypto extends PureComponent {
  static propTypes = {
    /**
...
ReceivedCrypto.contextType = ThemeContext;
...
export default connect(mapStateToProps)(ReceivedCrypto);
