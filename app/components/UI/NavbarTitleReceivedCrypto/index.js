 ...
 */
class NavbarTitleReceivedCrypto extends PureComponent {
  static propTypes = {
    /**
  ...
  render = () => {
    ...
    if (network.providerConfig.ticker) {
      name = network.providerConfig.ticker;
    } else {
      name =
        (Networks[network.providerConfig.type] &&
...
NavbarTitleReceivedCrypto.contextType = ThemeContext;
...
export default connect(mapStateToProps, mapDispatchToProps)(NavbarTitleReceivedCrypto);
